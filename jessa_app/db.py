...
SCHEMA_STATEMENTS = (
    ...
    CREATE TABLE IF NOT EXISTS evidence_chunks (
        ...
        confidentiality TEXT NOT NULL DEFAULT 'reusable',
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS evidence_sync_runs (
        id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    "CREATE INDEX IF NOT EXISTS idx_evidence_chunks_scope_job ON evidence_chunks(scope, job_id, active)",
    "CREATE INDEX IF NOT EXISTS idx_evidence_chunks_category ON evidence_chunks(category, active)",
    "CREATE INDEX IF NOT EXISTS idx_evidence_chunks_claim_status ON evidence_chunks(claim_status, active)",
)
...
def init_db() -> None:
    ...
    with get_db() as conn:
        ...
        _ensure_column(conn, "core_profile", "source_path", "TEXT NOT NULL DEFAULT ''")
        _ensure_column(conn, "core_profile", "source_sha256", "TEXT NOT NULL DEFAULT ''")
        _ensure_column(conn, "core_profile", "synced_at", "TEXT")
        ...
        _ensure_column(conn, "application_artifacts", "artifact_status", "TEXT NOT NULL DEFAULT 'draft'")
        _ensure_column(conn, "application_artifacts", "source_path", "TEXT NOT NULL DEFAULT ''")
        _ensure_column(conn, "application_artifacts", "source_sha256", "TEXT NOT NULL DEFAULT ''")
